<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            @else
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 h-56 flex items-center justify-center text-gray-300">
                    <div class="text-center">
                        <svg class="w-12 h-12 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14M14 8h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <span class="px-3 py-1 rounded-full text-xs font-semibold {{ $kosan->status === 'aktif' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500' }}">
                ...
                <div class="grid grid-cols-3 gap-4 py-4 border-y border-gray-100 mb-4">
                    <div class="text-center">
                        <p class="text-2xl font-bold text-green-700">Rp {{ number_format($kosan->harga_per_bulan, 0, ',', '.') }}</p>
                        <p class="text-xs text-gray-400 mt-0.5">per bulan</p>
                    </div>
                    <div class="text-center border-x border-gray-100">
                        <p class="text-2xl font-bold text-gray-800">{{ $kosan->kamar_tersedia }}/{{ $kosan->jumlah_kamar }}</p>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach($kosan->fasilitas as $f)
                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-700 text-sm rounded-lg font-medium border border-green-100">
                                ✓ {{ $f }}
                            </span>
                        @endforeach
                    </div>
